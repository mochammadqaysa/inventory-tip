...
@section('title', 'Laporan Pengeluaran Barang Jadi')
...
<div class="row">
  <div class="col-xl-12 order-xl-1">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('result-report.barang-keluar') }}" method="GET" id="myForm">
          <div class="row align-items-center" id="form-list">
            ...
            <div class="form-group col-md-12">
              ...
              @foreach(['semua' => 'Semua', 'lokal' => 'Lokal', 'ekspor' => 'Ekspor'] as $value => $label)
