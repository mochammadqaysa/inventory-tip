      ...
      <tbody>
        ...
        <tr>
          @if($item->bahanMasuk->nomor_bukti != $lastNomorBukti)
            <td>{{ $iteration }}</td>
            <td style="text-align: left">{{ $item->bahanMasuk->nomor_bukti }} ({{ $item->bahanMasuk->nomor_po }})</td>
            @php $iteration++; @endphp
            @else
            <td></td>
            <td style="text-align: left">({{ $item->bahanMasuk->nomor_po }})</td>
          @endif
          {{-- @if ($item->bahanMasuk->nomor_bukti != $lastNomorBukti)
          @else
              <td></td>
          ...
          <td style="text-align: right" class="digit">{!! Utils::decimal($item->nilai) !!}</td>
        ...
        @endforeach
        <tr class="xls-ignore">
          <td colspan="10" rowspan="2" class="total" style="text-align: end; font-size: 20px; letter-spacing: 20px">TOTAL</td>
