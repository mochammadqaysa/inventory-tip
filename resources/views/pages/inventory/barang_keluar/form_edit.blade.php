...
<div class="step-box">
      ...
      <div class="row">
        <div class="form-group col-md-12">
          ...
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="tipe2" checked name="tipe" class="custom-control-input" value="lokal" {{ @$data->tipe == "lokal" ? "checked" : "" }}>
            <label class="custom-control-label" for="tipe2">Lokal</label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="tipe1"  name="tipe" class="custom-control-input" value="ekspor" {{ @$data->tipe == "ekspor" ? "checked" : "" }}>
        ...
        <div class="form-group col-md-12">
          ...
          <select name="customer" class="form-control select2-customer" id="customer">
            <option></option>
            @if(isset($data->customer->uid))
            <option value="{{ $data->customer->uid }}" selected data-negara="{{$data->customer->negara}}">{{ $data->customer->nama }}</option>
            @endif
          </select>
        </div>
        <div class="form-group col-md-6">
          <label>Nomor Bukti <span class="text-danger">*</span></label>
          <input type="text" name="nomor_bukti" class="form-control" placeholder="Nomor Bukti" style="text-transform:uppercase" value="{{ @$data->nomor_bukti }}">
        </div>
        <div class="form-group col-md-6 ">
        ...
        <div class="form-group col-md-12" id="lokal-ppn">
          ...
          <div class="input-group">
              <input type="number" name="ppn" class="form-control" placeholder="PPN" value="{{ @$data->ppn }}">
        ...
        <div class="form-group col-md-6" id="ekspor-nomor-peb">
          ...
          <input type="text" name="nomor_peb" class="form-control" placeholder="Nomor PEB" style="text-transform:uppercase" value="{{ @$data->nomor_peb }}">
        </div>
        <div class="form-group col-md-6" id="ekspor-tgl-peb">
          <label>Tanggal PEB <span class="text-danger">*</span></label>
          <div class='date'>
            <input type='text' class="form-control" name="tanggal_peb" id='tanggal_peb' style="background-color: white; " placeholder="Pilih Tanggal PEB" value="{{ @$data->tanggal_peb }}" />
          </div>
        </div>
    ...
    <div class="step-body" data-tab="2" style="display: none;">
      <div class="col-md-10 mx-auto mb-5">
        <div id="dynamic-form">
          <!-- Original Form -->
          @foreach ($barangKeluarItems as $key => $barangItem)
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-12 ">
                      ...
                      <div class="input-group">
                          <input type="number" name="jumlah[]" class="form-control" placeholder="Jumlah" value="{{ $barangItem->jumlah }}">
                  ...
                  <div class="form-group col-md-6 " style="">
                      ...
                      <div class="input-group">
                          <input type="number" name="bruto[]" class="form-control" step=".001" placeholder="Bruto" value="{{ $barangItem->bruto }}">
                          <div class="input-group-append">
                  ...
                  <div class="form-group col-md-6 " style="">
                      ...
                      <div class="input-group">
                          <input type="number" name="netto[]" class="form-control" step=".001" placeholder="Netto" value="{{ $barangItem->netto }}">
                          <div class="input-group-append">
                              <span class="input-group-text">KG</span>
                          </div>
                      </div>
                  ...
                  <div class="form-group col-md-12 ekspor-mata-uang">
                      ...
                      <input type="text" name="mata_uang[]" class="form-control" placeholder="Mata Uang" style="text-transform:uppercase" value="{{ $barangItem->mata_uang }}">
                  </div>
                  <!-- Nilai -->
                  <div class="form-group col-md-12 " style="">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text prepend-currency">{{$barangItem->mata_uang}}</span>
                        </div>
                          <input type="number" name="nilai[]" class="form-control" step=".01" placeholder="Nilai" value="{{ $barangItem->nilai }}">
                      </div>
                  </div>
                  <!-- Nilai PPN -->
                  <div class="form-group col-md-6 lokal-nilai-ppn" style="">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="number" name="nilai_ppn[]" class="form-control" step=".01" placeholder="Nilai PPN" readonly value="{{ $barangItem->nilai_ppn }}">
                      </div>
                  </div>
                  <!-- Nilai Total -->
                  <div class="form-group col-md-6 lokal-nilai-total" style="">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="number" name="nilai_total[]" class="form-control" step=".01" placeholder="Nilai Total" readonly value="{{ $barangItem->nilai_total }}">
                      </div>
                  </div>
                </div>
              </div>
