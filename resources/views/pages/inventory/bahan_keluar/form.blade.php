      ...
      <div class="row">
        <div class="form-group col-md-12">
          ...
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="transaksi2" checked name="transaksi" class="custom-control-input" value="keluar">
            <label class="custom-control-label" for="transaksi2">Keluar</label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="transaksi1"  name="transaksi" class="custom-control-input" value="retur">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <select name="bahan[0]" class="form-control select2-bahan" aria-describedby="validatebahan1">
                      <option></option>
