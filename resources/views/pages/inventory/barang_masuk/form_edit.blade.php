...
<div class="step-box">
        ...
        <div class="form-group col-md-12">
          ...
          <select name="gudang" class="form-control select2-gudang" id="gudang">
            ...
            @foreach ($gudang as $item)
                <option value="{{$item->uid}}" {{ $item->uid == $data->gudang->uid ? "selected" : "" }}>{{$item->nama}}</option>
            @endforeach
          </select>
        </div>
      </div>
    ...
    <div class="step-body" data-tab="2" style="display: none;">
      <div class="col-md-10 mx-auto mb-5">
        <div id="dynamic-form">
          <!-- Original Form -->
          @foreach ($barangMasukItems as $key => $barangItem)
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-6 jumlah-kg" style="">
                      ...
                      <div class="input-group">
                          <input type="number" name="kg_per_item[]" class="form-control" step=".001" placeholder="KG / Item" value="{{$barangItem->kg_per_item}}">
