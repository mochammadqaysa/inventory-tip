  ...
  <div class="scrollbar-inner">
    ...
    <div class="navbar-inner">
      ...
      ->start_item_accordion('inventory', (
        Request::is('inventory/impor-bahan')
        ))
      ->customIconItem('Impor Bahan Baku', asset('assets/img/brand/import_bahan.svg'), 'inventory/impor-bahan',Request::is('inventory/impor-bahan'),['super_admin','exim'])
      ->customIconItem('Ekspor Bahan Baku', asset('assets/img/brand/export_bahan.svg'), 'inventory/backup-data',Request::is('inventory/backup-data'),['super_admin','exim'])
      ->customIconItem('Impor Barang Jadi', asset('assets/img/brand/import_barang.svg'), 'inventory/backup-data',Request::is('inventory/backup-data'),['super_admin','exim'])
      ->customIconItem('Ekspor Barang Jadi', asset('assets/img/brand/export_barang.svg'), 'inventory/backup-data',Request::is('inventory/backup-data'),['super_admin','exim'])
      ->customIconItem('Impor Waste / Scrap', asset('assets/img/brand/import_waste.svg'), 'inventory/backup-data',Request::is('inventory/backup-data'),['super_admin','exim'])
      ->customIconItem('Ekspor Waste / Scrap', asset('assets/img/brand/export_waste.svg'), 'inventory/backup-data',Request::is('inventory/backup-data'),['super_admin','exim'])
      ->end_item_accordion()
      ->end_accordion()
      ->end_group();
