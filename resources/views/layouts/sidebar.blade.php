...
<nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
  ...
  <div class="scrollbar-inner">
    ...
    <div class="navbar-inner">
      ...
      ->customIconItem('Pemasukan Barang Jadi', asset('assets/img/brand/file-barang.svg'), 'inventory/backup-data', Request::is('inventory/backup-data'),['super_admin','exim'])
      ->customIconItem('Pengeluaran Barang Jadi', asset('assets/img/brand/file-barang.svg'), 'inventory/backup-data', Request::is('inventory/backup-data'),['super_admin','exim'])
